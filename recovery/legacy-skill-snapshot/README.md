...
It contains the conversational front doors and supporting disciplines the owner
...
`WORKSPACE/.agents/upstream-matt-skills-2026-07-14/` for comparison.

## Discovery And Editing

Edit active skills here and promote preserved source from `skills-pending/`
only after its Workbench rewrite passes the catalog contract. WORKSPACE exposes this same directory to Claude through
