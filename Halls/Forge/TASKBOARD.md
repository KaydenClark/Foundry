...
| [S-015](specs/S-015-one-project-pilot-and-rollout/SPEC.md) | Acceptance / owner gate | Forge / Kayden | Owner approval of one named pilot project and an exact candidate version. | Contract recorded from the L-018 audit finding; no pilot or rollout has run. | Name the pilot project and candidate version, then authorize TK-001. |
