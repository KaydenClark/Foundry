...
**Current focus:** Preserve the legacy transport/health compatibility contract while Gauge's Gatehouse-passage and CIC activity contracts are staged under root `S-001`.
