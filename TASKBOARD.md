...
|---|---|---|---|---|---|
| [S-001](specs/S-001-portable-foundry-harness/SPEC.md) | TK-003: Cut an existing deployment such as GPT_OS over to this harness. (blocked) | codex | TK-002, owner approval | TK-002 proof reconfirmed at pushed commit `5f39491de28c6b7f6aac53d5ff9de4d1b4d7a188` after preflight hardening. | Present the proven harness for owner approval; do not begin the GPT_OS S-018/TK-003 cutover. |
<!-- hot-specs:end -->
